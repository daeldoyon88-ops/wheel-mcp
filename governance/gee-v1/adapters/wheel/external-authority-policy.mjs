...
const EXTERNAL_REINSPECTION_DECLARATIONS = Object.freeze([
    ...
    {
      authorityId: 'GATE16_M3_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT',
      classification: 'EXTERNAL_REINSPECTION_REPORT',
      path: 'governance/sources/GATE16_M3_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT.json',
      sha256: '774202ab4ed6124b333cf4e25a64130c4f9ad3cd49d998640a5a37421012d74d',
      gateId: 'GATE16',
      programId: 'GATE16_M3_INDEPENDENT_REINSPECTION_EXTERNAL_CONFIRMATION',
      reportShape: STANDARD_EXTERNAL_REINSPECTION_REPORT
    },
    {
      authorityId: 'GATE17_B_INDEPENDENT_FINAL_REPLAY_EXTERNAL_CONFIRMATION_EXTERNAL_REINSPECTION_REPORT',
      classification: 'EXTERNAL_REINSPECTION_REPORT',
      path: 'governance/sources/GATE17_B_INDEPENDENT_FINAL_REPLAY_EXTERNAL_CONFIRMATION_EXTERNAL_REINSPECTION_REPORT.json',
      sha256: '05ae7e5524d624d2be6db7aa258554164014044ec2e02182b206cf9ee3bcf46f',
      gateId: 'GATE17',
      programId: 'GATE17_B_INDEPENDENT_FINAL_REPLAY_EXTERNAL_CONFIRMATION',
      reportShape: STANDARD_EXTERNAL_REINSPECTION_REPORT
    },
    {
      authorityId: 'GATE19_FINAL_INDEPENDENT_REAUDIT_EXTERNAL_CONFIRMATION_EXTERNAL_REINSPECTION_REPORT',
      classification: 'EXTERNAL_REINSPECTION_REPORT',
      path: 'governance/sources/GATE19_FINAL_INDEPENDENT_REAUDIT_EXTERNAL_CONFIRMATION_EXTERNAL_REINSPECTION_REPORT.json',
      sha256: '6d6f329f1d6bd4ee81b98a8664be34e84961cac893b398d461745f71b635d6a1',
      gateId: 'GATE19',
      programId: 'GATE19_FINAL_INDEPENDENT_REAUDIT_EXTERNAL_CONFIRMATION',
      reportShape: STANDARD_EXTERNAL_REINSPECTION_REPORT
    },
    {
      authorityId: 'GATE20_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT',
      classification: 'EXTERNAL_REINSPECTION_REPORT',
      path: 'governance/sources/GATE20_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT.json',
      sha256: '9dc8b6978fae888a45301545628721fc8ac8719397022db6d9aded7eb646c0e4',
      gateId: 'GATE20',
      programId: 'GATE20_INDEPENDENT_EXTERNAL_CONFIRMATION_R1',
      reportShape: STANDARD_EXTERNAL_REINSPECTION_REPORT
    },
    {
      authorityId: 'GATE21_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT',
      classification: 'EXTERNAL_REINSPECTION_REPORT',
      path: 'governance/sources/GATE21_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT.json',
      sha256: '4962e8cb12fab276630ce6b402aa4ccbff4586318d8efcd040721b155ec57f14',
      gateId: 'GATE21',
      programId: 'GATE21_INDEPENDENT_EXTERNAL_CONFIRMATION_R1',
      reportShape: STANDARD_EXTERNAL_REINSPECTION_REPORT
    },
    {
      authorityId: 'GATE22_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT',
      classification: 'EXTERNAL_REINSPECTION_REPORT',
      path: 'governance/sources/GATE22_INDEPENDENT_EXTERNAL_CONFIRMATION_R1_EXTERNAL_REINSPECTION_REPORT.json',
      sha256: '720fc2566823ab6fce5a502a19d2fe8434cf3851205a317cbfa470858ae7a502',
      gateId: 'GATE22',
    ...
    {
      // GATE24 cites its reinspection report by REPOSITORY PATH, same as GATE23.
      ...
      authorityId: 'governance/sources/GATE24_INDEPENDENT_EXTERNAL_CONFIRMATION_R2_EXTERNAL_REINSPECTION_REPORT.json',
      classification: 'EXTERNAL_REINSPECTION_REPORT',
      path: 'governance/sources/GATE24_INDEPENDENT_EXTERNAL_CONFIRMATION_R2_EXTERNAL_REINSPECTION_REPORT.json',
      sha256: '54cea8f4226ba06c0f2c86215f317855652227023a2321884ddd86810f67e5d9',
      gateId: 'GATE24',

...
test('L4B-F1 schemas remain registered inside the 109-schema additive registry', () => {
  ...
  assert.deepEqual(SNAPSHOT_NAMESPACE_SCHEMA_VERSIONS.slice(-8, -4), MACRO_FEATURE_L4B_F1_SCHEMA_VERSIONS);
});

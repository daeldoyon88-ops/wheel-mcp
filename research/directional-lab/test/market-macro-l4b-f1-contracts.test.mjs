...
test('L4B-F1 registers exactly four snapshot schemas: 105 total, all unique', () => {
  ...
  assert.deepEqual(SNAPSHOT_NAMESPACE_SCHEMA_VERSIONS.slice(-4), MACRO_FEATURE_L4B_F1_SCHEMA_VERSIONS);
});

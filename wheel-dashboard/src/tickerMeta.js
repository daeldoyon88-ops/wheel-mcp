...
export const TICKER_META = {
  ...
  CRM:  { name: "Salesforce Inc.", type: "SaaS CRM / Cloud Enterprise", sector: "Technology", qualityTier: "Core Quality" },
  WMT:  { name: "Walmart Inc.", type: "Retail Défensif / Grande Distribution", sector: "Consumer Staples", qualityTier: "Core Quality" },
  ADSK: { name: "Autodesk Inc.", type: "Logiciel Design / CAD / Construction", sector: "Technology", qualityTier: "Core Quality" },
  MRK:  { name: "Merck & Co.", type: "Pharma Diversifiée", sector: "Healthcare", qualityTier: "Core Quality" },
  PANW: { name: "Palo Alto Networks Inc.", type: "Cybersécurité", sector: "Technology", qualityTier: "Core Quality" },
  RTX:  { name: "RTX Corp.", type: "Défense / Aérospatial", sector: "Industrials", qualityTier: "Core Quality" },
  SNPS: { name: "Synopsys Inc.", type: "EDA / Logiciel Semi-conducteurs", sector: "Technology", qualityTier: "Core Quality" },
  GILD: { name: "Gilead Sciences Inc.", type: "Biopharma / Antiviraux / Oncologie", sector: "Healthcare", qualityTier: "Core Quality" },
  CVX:  { name: "Chevron Corp.", type: "Majeure Pétrolière Intégrée", sector: "Energy", qualityTier: "Cyclique" },
  DIS:  { name: "The Walt Disney Co.", type: "Médias / Parcs / Streaming", sector: "Communication Services", qualityTier: "Cyclique" },
  LULU: { name: "lululemon athletica inc.", type: "Apparel Premium / Retail Growth", sector: "Consumer Discretionary", qualityTier: "Cyclique" },
  ABNB: { name: "Airbnb Inc.", type: "Voyage / Marketplace Hébergement", sector: "Consumer Discretionary", qualityTier: "Cyclique" },
  ALB:  { name: "Albemarle Corp.", type: "Lithium / Matériaux Batteries", sector: "Materials", qualityTier: "Cyclique" },
  DASH: { name: "DoorDash Inc.", type: "Livraison / Marketplace Locale", sector: "Consumer Discretionary", qualityTier: "Cyclique" },
  ENPH: { name: "Enphase Energy Inc.", type: "Solaire / Onduleurs", sector: "Energy", qualityTier: "Cyclique" },
  LRCX: { name: "Lam Research Corp.", type: "Équipement Semi-conducteurs", sector: "Technology", qualityTier: "Cyclique" },
  ON:   { name: "ON Semiconductor Corp.", type: "Semi-conducteurs Auto / Power", sector: "Technology", qualityTier: "Cyclique" },
  WDAY: { name: "Workday Inc.", type: "SaaS RH / Finance", sector: "Technology", qualityTier: "Cyclique" },
  WYNN: { name: "Wynn Resorts Ltd.", type: "Casinos / Resorts", sector: "Consumer Discretionary", qualityTier: "Cyclique" },
  CHWY: { name: "Chewy Inc.", type: "E-commerce Animaux", sector: "Consumer Discretionary", qualityTier: "Cyclique" },
  EL:   { name: "Estée Lauder Companies", type: "Beauté / Cosmétiques", sector: "Consumer Staples", qualityTier: "Cyclique" },
  OWL:  { name: "Blue Owl Capital Inc.", type: "Gestion Alternative / Private Credit", sector: "Financial Services", qualityTier: "Cyclique" },
  PSKY: { name: "Paramount Skydance Corporation", type: "Médias / Streaming / Studios", sector: "Communication Services", qualityTier: "Cyclique" },
  SU:   { name: "Suncor Energy Inc.", type: "Pétrole Intégré / Oil Sands Canada", sector: "Energy", qualityTier: "Cyclique" },
  TOST: { name: "Toast Inc.", type: "POS Restaurants / Paiements / SaaS", sector: "Technology", qualityTier: "Cyclique" },
  JOBY: { name: "Joby Aviation Inc.", type: "eVTOL / Aviation Électrique", sector: "Industrials", qualityTier: "Spéculatif favori" },
  BABA: { name: "Alibaba Group Holding Ltd.", type: "E-commerce / Cloud Chine ADR", sector: "Consumer Discretionary", qualityTier: "Thématique risqué" },
  EFA:  { name: "iShares MSCI EAFE ETF", type: "ETF Actions Développées Hors US", sector: "ETF", qualityTier: "Thématique risqué" },
  IAU:  { name: "iShares Gold Trust", type: "ETF Or Physique", sector: "Commodities", qualityTier: "Thématique risqué" },
  JD:   { name: "JD.com Inc.", type: "E-commerce Chine ADR", sector: "Consumer Discretionary", qualityTier: "Thématique risqué" },
  MOS:  { name: "Mosaic Co.", type: "Engrais / Potasse / Phosphate", sector: "Materials", qualityTier: "Thématique risqué" },
  VG:   { name: "Venture Global Inc.", type: "LNG / Gaz Naturel Liquéfié", sector: "Energy", qualityTier: "Thématique risqué" },
